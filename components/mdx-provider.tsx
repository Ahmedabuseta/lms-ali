...
interface DetailsProps { children: ReactNode;
  summary?: ReactNode; }

const Details = ({ children, summary }: DetailsProps) => { const [isOpen, setIsOpen] = useState(false);
...
const components = { h1: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
