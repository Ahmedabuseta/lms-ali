          ...
          <TableRow>
            ...
            <TableHead>
              <Button 
                ...
                className="flex items-center font-semibold p-0 h-auto hover:bg-transparent"
              >
          ...
          {sortedResults.map((result, index) => (
            <TableRow key={result.userId}>
              ...
              <TableCell>
                ...
                <div className="text-xs text-slate-500">{result.correct}/{result.total} correct</div>
              </TableCell>
              ...
              <TableCell>
                <div className={cn(
                  ...
                  {result.score >= 70 ? "Pass" : 
                   result.score >= 50 ? "Borderline" : "Fail"}
                </div>
              </TableCell>
            </TableRow>
          ))}
