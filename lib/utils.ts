 ...
 */
export function formatTime(milliseconds: number): string { // Handle edge cases
 ...
 */
export function formatMathExpression(content: string): string { // For inline math, make sure it's properly delimited
 ...
 */
export function formatMathSolution(problem: string, steps: string[]): string { const formattedProblem = `## Problem:\n\n${problem }\n\n`;
 ...
 */
export function formatDerivativeProblem(functionText: string, steps: { title: string; content: string }[]): string { let result = `## Problem:\n\nFind the derivative of $${functionText }$.\n\n`;
  result += `## Solution:\n\n`;
 ...
 */
export function formatLatex(latex: string): string { return (
    latex
