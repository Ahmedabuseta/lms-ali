...
const ExamPracticePage = ({ params }: ExamPracticePageProps) => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-blue-50/40 to-indigo-50/60 dark:from-background dark:via-blue-950/20 dark:to-purple-950/20 flex items-center justify-center animate-fade-in px-4" dir="rtl">
        <Card className="w-full max-w-sm sm:max-w-md shadow-xl border-0 bg-background/95 backdrop-blur-sm">
          <CardHeader className="text-center p-6 sm:p-8">
            <div className="flex justify-center mb-4 sm:mb-6">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg">
          ...
          <CardContent className="text-center pb-6 sm:pb-8 space-y-4 sm:space-y-6">
            ...
            <div className="w-full bg-muted rounded-full h-2 sm:h-3 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-500 to-indigo-500 h-2 sm:h-3 rounded-full animate-pulse transition-all duration-1000" style={{ width: '75%' }}></div>
            </div>
