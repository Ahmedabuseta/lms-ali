...
export function LearningInsights({
  ...
  return (
    <Card className="w-full overflow-hidden border-0 bg-gradient-to-br from-white via-blue-50 to-purple-50 shadow-2xl backdrop-blur-sm dark:from-gray-800 dark:via-blue-900/20 dark:to-purple-900/20">
      <CardHeader className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white">
        ...
        {/* Floating Elements */}
        <div className="absolute right-2 top-2 h-8 w-8 animate-pulse rounded-full bg-white/10"></div>
        <div className="animation-delay-1000 absolute bottom-2 left-2 h-6 w-6 animate-pulse rounded-full bg-white/10"></div>
      </CardHeader>

      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <div className="border-b border-gray-200 bg-white/50 px-6 py-4 backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/50">
          <TabsList className="w-full justify-start border-0 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/50 dark:to-purple-900/50">
            <TabsTrigger
              value="overview"
              className="text-sm font-medium transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-purple-600 data-[state=active]:text-white"
            >
              نظرة عامة
            </TabsTrigger>
            <TabsTrigger
        ...
        <TabsContent value="overview" className="m-0 p-0">
          <CardContent className="grid grid-cols-1 gap-6 p-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="group flex transform flex-col gap-3 rounded-2xl border border-blue-200/50 bg-gradient-to-br from-blue-50 to-indigo-100 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-blue-700/50 dark:from-blue-900/20 dark:to-indigo-900/20">
              <div className="flex items-start justify-between">
                <div className="text-sm font-medium text-gray-600 dark:text-gray-300">تقدم الدورة</div>
              ...
              <div className="absolute right-2 top-2 h-6 w-6 animate-pulse rounded-full bg-blue-500/20"></div>
            </div>

            <div className="group flex transform items-start gap-4 rounded-2xl border border-purple-200/50 bg-gradient-to-br from-purple-50 to-pink-100 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-purple-700/50 dark:from-purple-900/20 dark:to-pink-900/20">
              <div className="rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 p-3 transition-transform duration-300 group-hover:scale-110">
                <Clock className="h-6 w-6 text-white" />
              </div>
              <div>
                <div className="text-sm font-medium text-gray-600 dark:text-gray-300">إجمالي التعلم</div>
                <div className="text-3xl font-bold text-gray-800 dark:text-white">{totalHours} ساعة</div>
              </div>
            </div>

            <div className="group flex transform items-start gap-4 rounded-2xl border border-green-200/50 bg-gradient-to-br from-green-50 to-emerald-100 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-green-700/50 dark:from-green-900/20 dark:to-emerald-900/20">
              <div className="rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 p-3 transition-transform duration-300 group-hover:scale-110">
                <Calendar className="h-6 w-6 text-white" />
              </div>
              <div>
                <div className="text-sm font-medium text-gray-600 dark:text-gray-300">تتابع الدراسة</div>
                <div className="text-3xl font-bold text-gray-800 dark:text-white">{studyStreak} أيام</div>
              </div>
            </div>

            <div className="group flex transform items-start gap-4 rounded-2xl border border-orange-200/50 bg-gradient-to-br from-orange-50 to-red-100 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-orange-700/50 dark:from-orange-900/20 dark:to-red-900/20">
              <div className="rounded-xl bg-gradient-to-r from-orange-500 to-red-500 p-3 transition-transform duration-300 group-hover:scale-110">
                <Award className="h-6 w-6 text-white" />
              </div>
              <div>
                <div className="text-sm font-medium text-gray-600 dark:text-gray-300">الإنجازات</div>
                <div className="text-3xl font-bold text-gray-800 dark:text-white">3 جديد</div>
              </div>
            </div>
          </CardContent>
          ...
          <CardFooter className="border-t border-gray-200 bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-50 px-6 py-4 dark:border-gray-700 dark:from-blue-900/10 dark:via-purple-900/10 dark:to-indigo-900/10">
            <Button
              variant="outline"
              size="lg"
              className="mr-auto transform border-2 border-blue-600 text-blue-600 transition-all duration-300 hover:scale-105 hover:bg-blue-600 hover:text-white"
        ...
        <TabsContent value="activity" className="m-0 p-0">
          <CardContent className="space-y-4 p-6">
            ...
            {recentActivity.map((activity, i) => (
              <div
                key={i}
                className="group flex transform items-center gap-4 rounded-xl border border-gray-200 bg-white p-4 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800/50 dark:hover:border-blue-600"
              >
                <div
                ...
                <div className="min-w-0 flex-1">
                  <div className="truncate text-base font-semibold text-gray-800 dark:text-white">{activity.title}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">{activity.date}</div>
                  {activity.progress !== undefined && <Progress value={activity.progress} className="mt-3 h-2" />}
                </div>
              </div>
            ))}
          </CardContent>
