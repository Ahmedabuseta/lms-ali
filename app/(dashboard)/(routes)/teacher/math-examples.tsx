...
export default function MathExamples() {
  const examples = [
    {
      title: "Basic Algebra",
    ...
    },
    {
      ...
      content: "In a right triangle, the square of the length of the hypotenuse equals the sum of squares of the other two sides: $a^2 + b^2 = c^2$"
    },
    {
    ...
    },
    {
      ...
      content: "The sum of an infinite geometric series with first term $a$ and common ratio $r$ (where $|r| < 1$) is:\n\n$$S = \\frac{a}{1-r}$$"
    },
    {
      title: "Matrix",
      content: "A matrix can be represented as:\n\n$$A = \\begin{pmatrix} a_{11} & a_{12} \\\\ a_{21} & a_{22} \\end{pmatrix}$$"
    },
    {
      title: "Probability",
    ...
    },
    {
      ...
      content: "The probability density function of a normal distribution is:\n\n$$f(x) = \\frac{1}{\\sigma\\sqrt{2\\pi}}e^{-\\frac{1}{2}\\left(\\frac{x-\\mu}{\\sigma}\\right)^2}$$"
    },
    {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="mt-8">
        <h2 className="text-xl font-bold mb-4">Sample Multiple Choice Question</h2>
      ...
      <div className="mt-8">
        <h2 className="text-xl font-bold mb-4">Sample True/False Question</h2>
        <Card className="p-4 shadow-md">
          <div className="mb-4">
            <h3 className="text-lg font-medium">Question:</h3>
            <MathRenderer content="The equation $\\frac{d}{dx}(x^n) = nx^{n-1}$ is true for all values of $n$." className="text-lg" />
          </div>
