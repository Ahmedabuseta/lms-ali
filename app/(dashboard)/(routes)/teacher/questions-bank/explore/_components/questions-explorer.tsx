...
const PassageCard = ({ passage, questionCount, onView }: PassageCardProps) => {
  ...
  const handleView = async () => {
    ...
    try {
      ...
      // Reset loading after a short delay for visual feedback
  ...
  return (
    <div className={`group relative overflow-hidden rounded-xl border border-white/20 bg-gradient-to-br from-indigo-500/10 to-purple-600/10 backdrop-blur-sm transition-all duration-300 ${
      isLoading ? 'opacity-60 cursor-wait pointer-events-none' : 'hover:border-white/30 hover:shadow-lg hover:shadow-indigo-500/10'
    } dark:border-white/10 dark:from-indigo-400/20 dark:to-purple-500/20 dark:hover:border-white/20 dark:hover:shadow-indigo-400/20`}>
...
const QuestionCard = ({ question, onView, onEdit, onDelete }: QuestionCardProps) => {
  ...
  return (
    <div className={`group relative overflow-hidden rounded-xl border backdrop-blur-sm transition-all duration-300 ${
      isDisabled ? 'opacity-60 pointer-events-none cursor-wait' : 'hover:shadow-xl hover:shadow-black/5 dark:hover:shadow-black/20'
    } bg-gradient-to-br ${getTypeColor(question.type)}`}>
