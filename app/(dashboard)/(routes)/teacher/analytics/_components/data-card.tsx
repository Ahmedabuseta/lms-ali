...
type DataCardProps = { value: number;
  label: string;
...
const variants = { default: 'border-l-4 border-l-slate-500 relative overflow-hidden',
...
const gradients = { default: 'bg-gradient-to-br from-slate-500/10 via-transparent to-gray-500/5',
