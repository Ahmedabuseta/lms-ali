...
interface PracticeOptionsProps { onRefresh: () => void;
  onShowSettings: () => void; }

export const PracticeOptions = ({ onRefresh, onShowSettings }: PracticeOptionsProps) => { const [isRefreshing, setIsRefreshing] = useState(false);
