  ...
  return (
    <div className="space-y-6 p-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-right text-2xl font-bold">نتائج الامتحان: {attempt.exam.title}</h1>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <Card className="md:col-span-2">
          ...
          <CardContent className="p-6">
            ...
            {!isPass && (
              <div className="mt-6 rounded-md border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-950/50 dark:text-amber-400">
                <p className="text-right font-medium">توصية:</p>
                <p className="mt-1 text-right">
                  راجع الأسئلة التي أخطأت فيها أدناه وحاول مرة أخرى لتحسين درجتك. تحتاج إلى درجة 70% أو أعلى للنجاح.
                </p>
              </div>
            )}
          </CardContent>
      ...
      <Card>
        <CardHeader className="bg-slate-50 pb-3 dark:bg-slate-800/50">
          ...
          <CardDescription className="text-right">راجع جميع الأسئلة وانظر أيها أجبت عليه بشكل صحيح</CardDescription>
        </CardHeader>
        <CardContent className="p-6">
        ...
        <CardFooter className="flex flex-row-reverse justify-between border-t bg-slate-50 p-6 dark:bg-slate-800/50">
          <Button variant="outline" asChild>
