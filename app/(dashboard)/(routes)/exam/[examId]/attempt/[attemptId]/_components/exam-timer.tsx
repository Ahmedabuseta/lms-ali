...
export const ExamTimer = ({
  ...
  useEffect(() => {
    ...
    if (!storedTimer) {
      localStorage.setItem(storedTimerKey, JSON.stringify({
        endTime,
        timeLimit
      }))
    }
  ...
  return (
    <div className="space-y-2">
      <Card className={`p-4 transition-colors ${
        isAlmostTimeUp 
          ? 'bg-red-50 dark:bg-red-950/50 border-red-300 dark:border-red-800 animate-pulse' 
          : isWarning 
