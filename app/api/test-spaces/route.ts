  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      if (error.message.includes('Missing required environment variables')) {
        errorType = 'MissingEnvironmentVariables';
    ...
    const errorResponse = {
      ...
      timestamp: new Date().toISOString(),
      troubleshooting: {
        MissingEnvironmentVariables: 'Add the missing environment variables to your .env.local file',
        ...
        UnknownError: 'Check the console logs for more details'
      }[errorType] || 'Check the setup guide for troubleshooting steps'
    };
